...
const SubscriptionCard = ({ name, price, currency, icon, billing ,color,category,paymentMethod,renewalDate,plan,onPress,expanded,startDate,status}: SubscriptionCardProps) => {
    return (
